            ...
            <Row>
              <Col md={8} className="home-about-description">
                ...
                <p className="home-about-body">
                 Hey, my name's <span className="yellow">William </span>
                ...
                <br />
                  ...
                  I enjoy tackling new challenges and continuously learning new valuable skills.
                  <br />
                  <br />I am proficient in
                    <b className="yellow"> Javascript, </b>
                    as well as have knowledge in programming languages such as HTML, CSS,
